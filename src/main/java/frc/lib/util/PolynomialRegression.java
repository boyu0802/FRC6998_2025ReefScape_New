...
/******************************************************************************
 *  Compilation:  javac PolynomialRegression.java
 *  Execution:    java PolynomialRegression
 *  Dependencies: Jama.Matrix.java Jama.QRDecomposition.java
 *
 *  % java PolynomialRegression
 *  0.01 n^3 + -1.64 n^2 + 168.92 n + -2113.75  (R^2 = 0.997)
 *
 ******************************************************************************/
